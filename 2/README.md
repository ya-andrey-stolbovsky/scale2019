...
8. Подставьте туда URL очереди, созданной ранее — его можно получить в свойствах ранее созданной [очереди](https://console.cloud.yandex.ru/folders/b1g7gmun4vhqiidrucf7/message-queue).
